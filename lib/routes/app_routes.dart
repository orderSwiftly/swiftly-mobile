  ...
  static Route<dynamic>? onGenerateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case riderDeliveries:
        ...
        return MaterialPageRoute(builder: (_) => const PlaceholderScreen(title: 'Deliveries'));
      case riderProfile:
        // return MaterialPageRoute(builder: (_) => const RiderProfileScreen());
        return MaterialPageRoute(builder: (_) => const PlaceholderScreen(title: 'Profile'));
      
      // Store Owner routes
      case storeDashboard:
        return MaterialPageRoute(builder: (_) => const StoreOwnerDashboardScreen());
      case storeProducts:
        // return MaterialPageRoute(builder: (_) => const StoreProductsScreen());
        return MaterialPageRoute(builder: (_) => const PlaceholderScreen(title: 'Products'));
      case storeInventory:
        // return MaterialPageRoute(builder: (_) => const StoreInventoryScreen());
        return MaterialPageRoute(builder: (_) => const PlaceholderScreen(title: 'Inventory'));
      case storeProfile:
